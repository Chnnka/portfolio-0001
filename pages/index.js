...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Channaka Gunawardhane</title>
      ...
      <main className="bg-white px-10 md:text-center md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="font-burtons text-xl dark:text-gray-400">channaka_dev</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800  max-w-xl mx-auto md:text-xl dark:text-gray-500">
        ...
        <section>
          <div>
            <h3 className="text-3xl py-1 dark:text-gray-300">What I do?</h3>
        ...
        <section className="py-10">
          <div>
            <h3 className="text-3xl py-1 dark:text-gray-300">Portofolio</h3>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-400">
              Since the beginning of my journey as a freelance designer and
              developer, I've done remote work for
              <span className="text-teal-500"> agencies </span>
